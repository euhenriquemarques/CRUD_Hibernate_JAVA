...
public class ConsultaContoleFinanceiroMes {
	...
	public static void main(String[] args) {
		...
		String consulta = "Select cf from ControleFinanceiro cf where cf.mes = :pMes";
		
		// passando para query qual a string que é para executar
		Query query = em.createQuery(consulta);
		
		// defirindo o paratimer do filtro
		query.setParameter("pMes", controle.getMes());
